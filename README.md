...
It is designed to sit on top of `lossmodels`. In this setup, `lossmodels` provides the individual loss or aggregate loss models, and `risksim` combines them into portfolios, applies aggregate contracts, and summarizes the simulated results.
